    ...
    <q-page-container>
      <q-form class="q-px-sm q-pt-xl center-container">
        <div class="q-pa-md form-container">
          ...
          <!-- Company -->
          <q-input outlined v-model="company" label="Company" />
          <br />
          ...
          <!-- Customer Nme-->
          <q-input outlined v-model="customer" label="Customer" readonly />
          <br />
          ...
          <!-- IP Address-->
          <q-input outlined v-model="ipAddress" label="IP Address" readonly />
          <br />
          ...
          <div id="signature-pad" class="signature-pad">
            <div class="signature-pad--body">
              <canvas style="border-style: solid; border-width: 1px"></canvas>
            </div>
...
const submit = async () => {
  try {
    ...
    const response = await appApi.post('/api/Incidents/SaveSignature', data);
    ...
    if (response.status == 200) {
      ...
      console.error('Failed to save signature, status code:', response.status);
    }
  } catch (error) {
